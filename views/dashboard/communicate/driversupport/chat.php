        ...
        <div class="app-container">
          ...
          <div class="app-hero-header d-flex align-items-center">
            ...
            <div class="d-flex align-items-center">
              ...
              <div>
                <h3 class="mb-1 fw-bold">Chat</h3>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                    <li class="breadcrumb-item"><a href="/dashboard/communicate/driver-support">Driver Support</a></li>
                    		...
                    		<div class="card-body">
                    			<div class="table-responsive">
                    			 <div class="container mt-5 mb-5">
                                    ...
                                    <?php 
                                        // echo "<pre>";
                                        // print_r($this->chats[0]);
                                        // echo "</pre>";
                                            $out = '';
                                            foreach ($this->chats as $row) {
                                                $time = date('Y/m/d H:i:s',$row['timestamp']['_seconds']);
                                                $align = $row['sender'] != 'driver' ? 'text-end' : 'text-start';
                                                $out .= "<div class='$align mb-2' style='overflow:auto;color:darkgrey'><strong>{$row['message']}</strong>
     ...
     <script>
            $(function() {
                $('#chatform').submit(function(e) {
                    ...
                    const data = _data(form, 'new_reply_driver');
