...
<footer class="main-footer">
    ...
    <button id="playButton" class='d-none' style="border:0; outline:0; background:transparent">i</button>
</footer>

<script src="/assets/js/jquery.min.js"></script>
<script src="/assets/js/bootstrap.bundle.min.5.3.7.js"></script>
...
<!-- Apex Charts -->
    ...
    <!--<script src="/assets/js/visits-conversions.js"></script> -->
    <!-- Rating -->
