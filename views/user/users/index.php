    ...
    <main class="wrapper">
        ...
        require ADMIN . 'includes/sidebar.inc.php' ?>
            ...
            <div class="content-header"> 
                ...
                <?php //echo '<pre>'; print_r($this->users); echo '</pre>'; ?>
            </div>
                        ...
                        <div class='table-responsive'>
                            <table class='table table-striped table-hover'>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        <td> <?php echo $row['name'] ?>   <?= $row['status']=='active' ? $v : $nv ?>
                                            <!--<a class=' btn btn-sm btn-secondary ' href='#/<?= PROFILE_NAV ?>/users/edit?id=<?php echo $row['uid'] ?>'  ><i class='fa fa-pencil'></i></a>-->
                                        </td>
                                        <td><?php echo $row['email'] ?> <? //= $row['status']=='active' ? $v : $nv ?> <span></span> </td> 
                                        <td><?php echo $row['phone'] ?> <? //= $row['user_phone_verified']=='True' ? $v : $nv ?> </td>
                                        <td><?php echo $row['role'] ?> </td>
                                        <td><?php echo date('d-m-Y', $row['created_at']['_seconds']) ?> </td>
                                        <td><?php echo date('d-m-Y', $row['updated_at']['_seconds']) ?> </td>
                                         
                                        
                                        <td><a style='color:red' class='dropUsers' href='#' rel='<?php echo $row['uid'] ?>'   ><i class='fa fa-trash'></i></a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
