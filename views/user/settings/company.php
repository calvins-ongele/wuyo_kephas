    ...
    <main class="wrapper">
        ...
        <div class="content-wrapper px-2 py-2">
            <div class="content-header">
                <h1>Change or provide details</h1>
            </div>
                        ...
                        <div class='form-group'>
                            <div class='row'>
                                ...
                                <div class='col-md-6 mb-3'>
                                    ...
                                    <input class='form-controxl ucdata' style='min-width:100%' type='range' min="0.1" max="1" step="0.1" rel='audio'  value='<?php echo $me['audio'] ?>'>
