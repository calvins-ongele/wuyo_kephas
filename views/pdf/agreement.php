...
<head>
  ...
  <style id="text-unlocker-style">
    ...
    </style><style id="text-unlocker-style">
      * {
        user-select: text !important;
        -webkit-user-select: text !important;
        -moz-user-select: text !important;
...
All Course Works accessed through this portal require the production of original research and findings. You are expected to engage directly with primary sources, conduct field or empirical investigations as specified, and present conclusions that emerge from your own intellectual process and inquiry.

2. PROHIBITION ON AI-GENERATED WORK

You may not submit, present, or represent as your own any written content, analysis, argument, summary, or finding that was substantially generated by an artificial intelligence system — including but not limited to large language models such as ChatGPT, Claude, Gemini, Copilot, or any equivalent tool.

3. PERMISSIBLE USE OF AI TOOLS

AI tools may be used only for grammar and spelling correction of your own originally written text, citation formatting assistance, or summarising external sources to aid your own reading — provided the final written product is entirely your own. Any permissible AI use must be disclosed in a "Tool Use Statement" appended to your submission.

4. PRIMARY DATA COLLECTION OBLIGATION

Where a Course Work specifies field research, interviews, surveys, or other primary data collection, you must conduct those activities in person and in good faith. Fabricating or AI-generating interview responses, observational notes, or survey data constitutes academic fraud.
...
By proceeding, you acknowledge that:
   a) You have read and understood the full terms above
   ...
   c) You consent to your submission being subject to academic integrity review
                     ...
                     <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                        ...
                        <button id="skipfrlater" style="display: flex; align-items: center; gap: 8px; padding: 11px 20px; border: 1.5px solid rgb(208, 213, 221); border-radius: 6px; background-color: rgb(249, 250, 251); font-size: 14px; font-weight: 600; color: rgb(51, 51, 51); cursor: pointer;"><span style="font-size: 13px;">—</span>Skip — I'll review later</button>
                    </div>
                    <p id="dispwarning" style="display:none; font-size: 13px; color: rgb(138, 88, 0); background-color: rgb(255, 251, 240); border: 1px solid rgb(240, 208, 128); border-radius: 6px; padding: 10px 14px; margin-top: 12px;">Note: Skipping this agreement will be recorded. Your instructor may follow up before accepting your submission.</p>
                  </section>
                  <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 8px; gap: 12px;">
                     <button onclick="history.back()" style="padding: 12px 24px; background: none; border: 1.5px solid rgb(208, 213, 221); border-radius: 6px; font-size: 14px; font-weight: 600; color: rgb(85, 85, 85); cursor: pointer;">← Back</button>
                     <button id="continuetosignin" disabled="true" style="display: flex; align-items: center; justify-content: center; padding: 14px 40px; background-color: rgb(176, 190, 197); color: rgb(255, 255, 255); border-width: medium; border-style: none; border-color: currentcolor; border-image: initial; border-radius: 6px; font-size: 15px; font-weight: 700; cursor: not-allowed;">
                        Continue to Sign In
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" style="margin-left: 8px;">
                           <path d="M5 9h8M9 5l4 4-4 4" stroke="white" stroke-width="1.8" stroke-linecap="round"></path>
                        </svg>
                     </button>
                     <script>
                        const IhaveRead = document.querySelector("#IhaveRead");
                        const signInButton = document.querySelector("#continuetosignin");
                        ...
                        signInButton.addEventListener('click',(e)=> {
                            location.href="/assignments/sign-in";
                        })
                     </script>
                  </div>
                  <p style="font-size: 13px; color: rgb(136, 136, 136); text-align: center; margin-top: 8px;">Please respond to the agreement above to continue.</p>
               </div>
            </div>
         </main>
