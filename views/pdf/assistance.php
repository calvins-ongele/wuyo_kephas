...
<html lang="en">
                  ...
                  style="max-width: 520px; width: 100%; background-color: rgb(255, 255, 255); border-radius: 8px; border: 1px solid rgb(232, 217, 192); box-shadow: rgba(0, 85, 162, 0.08) 0px 2px 16px; padding: 40px 48px;">
                     ...
                     <div id="emailDiv" class="hidden" style="justify-content: center; padding: 48px 24px; ">
                         <div style="max-width: 520px; width: 100%; background-color: rgb(255, 255, 255); border-radius: 8px; border: 1px solid rgb(232, 217, 192); box-shadow: rgba(0, 85, 162, 0.08) 0px 2px 16px; padding: 40px 48px;">
                             ...
                             <text x="28" y="53" text-anchor="middle" fill="<?= $primary ?>" font-size="7" font-weight="bold" font-family="Arial, sans-serif" letter-spacing="1.2"><?= $this->_company['c_name'] ?></text></svg>
                             <div style="display: flex; flex-direction: column;">
                                 <span style="font-size: 17px; font-weight: 700; color: <?= $primary ?>; font-family: Georgia, serif;">Student Assistance Portal</span><span style="font-size: 12px; color: <?= $primary ?>; font-weight: 600; letter-spacing: 0.3px; margin-top: 2px;"><?= $this->_company['c_name'] ?></span></div></div>
                                 <div style="display: flex; align-items: center; margin-bottom: 28px;"><div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
                                     <div style="width: 26px; height: 26px; border-radius: 50%; display: flex; align-items: center; justify-content: center; background: <?= $primary ?>; border-width: medium; border-style: none; border-color: currentcolor; border-image: initial; color: rgb(255, 255, 255); font-size: 12px; font-weight: 600;">
                                         ...
                                         </div><span style="font-size: 11px; font-weight: 500; color: <?= $primary ?>;">Role</span></div>
                                         <div style="flex: 1 1 0%; height: 1.5px; margin: 0px 6px 18px; background: <?= $primary ?>;"></div><div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
                                             ...
                                             <span style="font-size: 11px; font-weight: 500; color: <?= $primary ?>;">Email</span></div>
                                             <div style="flex: 1 1 0%; height: 1.5px; margin: 0px 6px 18px; background: rgb(232, 217, 192);"></div>
                                             <div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
                                                     ...
                                                     <div style="width: 26px; height: 26px; border-radius: 50%; display: flex; align-items: center; justify-content: center; background: transparent; border: 1.5px solid rgb(187, 187, 187); color: rgb(170, 170, 170); font-size: 12px; font-weight: 600;">4</div><span style="font-size: 11px; font-weight: 500; color: rgb(170, 170, 170);">Access</span></div></div><div style="display: flex; flex-direction: column; align-items: flex-start; justify-content: space-between; margin-bottom: 10px;">
                                                         ...
                                                         <div style="font-size: 11px;"><span style="display: block;">Powered by</span><a href="https://preply.com" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none; border: 1px solid rgb(232, 232, 232); border-radius: 6px; padding: 2px; background: rgb(250, 250, 250);">
                                                             <img src="/public/assets/uploads/preply.ico" width="14" height="14" alt="Preply" style="display: inline-block;"></a><a href="https://www.cambly.com" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none; border: 1px solid rgb(232, 232, 232); border-radius: 6px; padding: 2px; background: rgb(250, 250, 250);">
                                                               ...
                                                               </div></div><p style="font-size: 14px; color: rgb(68, 68, 68); line-height: 1.7; margin-bottom: 22px;">Enter your tutoring account email. The portal will notify your session coordinator and confirm your outsourced tutor status before sign-in.</p><label style="font-size: 13px; font-weight: 600; color: rgb(68, 68, 68); display: block; margin-bottom: 6px;">Tutor email address</label><input id="tutorEmail" type="email" placeholder="you@example.com" value="" style="width: 100%; box-sizing: border-box; padding: 10px 12px; border: 1.5px solid rgb(208, 213, 221); border-radius: 6px; font-size: 14px; margin-bottom: 4px;"><button 
                                                               id="tutorEmailSubmit" style="width: 100%; padding: 12px 0px; background: <?= $primary ?>; color: rgb(255, 255, 255); border-width: medium; border-style: none; border-color: currentcolor; border-image: initial; border-radius: 6px; font-size: 14px; font-weight: 600; cursor: pointer; margin-top: 8px; margin-bottom: 4px; opacity: 1;">Continue</button><button style="width: 100%; padding: 9px 0px; background: none; border-width: medium; border-style: none; border-color: currentcolor; border-image: initial; font-size: 13px; color: rgb(136, 136, 136); cursor: pointer;">← Back</button><p style="font-size: 12px; color: rgb(136, 136, 136); line-height: 1.6; margin: 16px 0px 0px;">By signing in, you confirm you are accessing this assignment through an authorized link. Unauthorized access attempts are logged.</p></div></div>
                     <!----------------------------sign in with google--------------->
                     <div id="signDiv" class="hidden" style="justify-content: center; padding: 48px 24px;"><div style="max-width: 520px; width: 100%; background-color: rgb(255, 255, 255); border-radius: 8px; border: 1px solid rgb(232, 217, 192); box-shadow: rgba(0, 85, 162, 0.08) 0px 2px 16px; padding: 40px 48px;"><div style="display: flex; align-items: center; gap: 14px; margin-bottom: 28px;"><svg width="56" height="56" viewBox="0 0 56 56" fill="none"><rect width="56" height="56" rx="6" fill="#FFC425"></rect><path d="M28 9c-1.4 0-2.4.6-3 1.5-.5.7-.5 1.6-.1 2.3.2.5.6.9 1.1 1.3-.9.4-1.7 1-2.2 2-.4.7-.4 1.5 0 2.2.3.5.6.9 1.1 1.1-.6.4-1 1.1-1.2 1.9-.2 1 .1 2.1.8 2.8-.3.3-.6.6-.7 1.1-.2.8 0 1.7.6 2.2.3.3.8.6 1.3.6v3.3c0 .4-.1.8-.4 1.2l-3.3 5.2c-.3.6-.2 1.3.2 1.7.3.3.6.4 1 .4.4 0 .7-.2.9-.5l2.5-3.9v6.4c0 .6.5 1.2 1.2 1.2s1.2-.5 1.2-1.2v-6.4l2.5 3.9c.2.3.5.5.9.5.4 0 .7-.1 1-.4.4-.4.5-1.1.2-1.7l-3.3-5.2c-.2-.4-.4-.8-.4-1.2v-3.3c.5 0 .9-.3 1.3-.6.6-.5.8-1.4.6-2.2-.1-.5-.4-.8-.7-1.1.7-.7 1-1.8.8-2.8-.2-.8-.6-1.5-1.2-1.9.5-.2.8-.6 1.1-1.1.4-.7.4-1.5 0-2.2-.5-1-1.3-1.6-2.2-2 .5-.4.9-.8 1.1-1.3.4-.7.4-1.6-.1-2.3C30.4 9.6 29.4 9 28 9z" fill="<?= $primary ?>"></path><text x="28" y="53" text-anchor="middle" fill="<?= $primary ?>" font-size="7" font-weight="bold" font-family="Arial, sans-serif" letter-spacing="1.2"><?= $this->_company['c_name'] ?></text></svg><div style="display: flex; flex-direction: column;"><span style="font-size: 17px; font-weight: 700; color: <?= $primary ?>; font-family: Georgia, serif;">Student Assistance Portal</span><span style="font-size: 12px; color: <?= $primary ?>; font-weight: 600; letter-spacing: 0.3px; margin-top: 2px;"><?= $this->_company['c_name'] ?></span></div></div><div style="display: flex; align-items: center; margin-bottom: 28px;"><div style="display: flex; flex-direction: column; align-items: center; gap: 4px;"><div style="width: 26px; height: 26px; border-radius: 50%; display: flex; align-items: center; justify-content: center; background: <?= $primary ?>; border-width: medium; border-style: none; border-color: currentcolor; border-image: initial; color: rgb(255, 255, 255); font-size: 12px; font-weight: 600;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M2 6.5l2.5 2.5 5.5-5.5" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path></svg></div><span style="font-size: 11px; font-weight: 500; color: <?= $primary ?>;">Role</span></div><div style="flex: 1 1 0%; height: 1.5px; margin: 0px 6px 18px; background: <?= $primary ?>;"></div><div style="display: flex; flex-direction: column; align-items: center; gap: 4px;"><div style="width: 26px; height: 26px; border-radius: 50%; display: flex; align-items: center; justify-content: center; background: <?= $primary ?>; border-width: medium; border-style: none; border-color: currentcolor; border-image: initial; color: rgb(255, 255, 255); font-size: 12px; font-weight: 600;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M2 6.5l2.5 2.5 5.5-5.5" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path></svg></div><span style="font-size: 11px; font-weight: 500; color: <?= $primary ?>;">Email</span></div><div style="flex: 1 1 0%; height: 1.5px; margin: 0px 6px 18px; background: <?= $primary ?>;"></div><div style="display: flex; flex-direction: column; align-items: center; gap: 4px;"><div style="width: 26px; height: 26px; border-radius: 50%; display: flex; align-items: center; justify-content: center; background: <?= $primary ?>; border-width: medium; border-style: none; border-color: currentcolor; border-image: initial; color: rgb(255, 255, 255); font-size: 12px; font-weight: 600;">3</div><span style="font-size: 11px; font-weight: 500; color: <?= $primary ?>;">Sign in</span></div><div style="flex: 1 1 0%; height: 1.5px; margin: 0px 6px 18px; background: rgb(232, 217, 192);"></div><div style="display: flex; flex-direction: column; align-items: center; gap: 4px;"><div style="width: 26px; height: 26px; border-radius: 50%; display: flex; align-items: center; justify-content: center; background: transparent; border: 1.5px solid rgb(187, 187, 187); color: rgb(170, 170, 170); font-size: 12px; font-weight: 600;">4</div><span style="font-size: 11px; font-weight: 500; color: rgb(170, 170, 170);">Access</span></div></div><h2 style="font-size: 20px; font-weight: 700; color: <?= $primary ?>; margin: 0px 0px 10px; font-family: Georgia, serif;">Sign in to access your student's course work</h2><i style="font-size: 13px; color: rgb(85, 85, 85);">You are signing in as a Tutor</i><div style="display: inline-flex; align-items: center; gap: 8px; background: rgb(255, 248, 231); border: 1px solid rgb(232, 201, 106); border-radius: 6px; padding: 5px 12px; margin-bottom: 14px;"><span style="font-size: 13px; color: <?= $primary ?>;">calvinsongele@gmail.com</span><button style="background: none; border-width: medium; border-style: none; border-color: currentcolor; border-image: initial; font-size: 12px; color: rgb(136, 136, 136); cursor: pointer; padding: 0px;">change</button></div><p style="font-size: 14px; color: rgb(68, 68, 68); line-height: 1.7; margin-bottom: 22px;">Sign in with your preferred tutor Google account.</p><button id="signinWithEmail" style="display: flex; align-items: center; justify-content: center; gap: 12px; width: 100%; padding: 13px 0px; background: rgb(255, 255, 255); color: <?=  $accent ?>; border: 1.5px solid rgb(208, 213, 221); border-radius: 6px; font-size: 15px; font-weight: 600; cursor: pointer; box-shadow: rgba(0, 0, 0, 0.08) 0px 1px 4px; margin-bottom: 4px;"><svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M19.6 10.23c0-.68-.06-1.36-.18-2H10v3.8h5.4a4.62 4.62 0 01-2 3.03v2.5h3.24C18.4 15.93 19.6 13.3 19.6 10.23z" fill="#4285F4"></path><path d="M10 20c2.7 0 4.97-.9 6.62-2.44l-3.23-2.5c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.6-4.13H1.07v2.58A9.99 9.99 0 0010 20z" fill="#34A853"></path><path d="M4.4 11.89A6 6 0 014.18 10c0-.66.11-1.3.22-1.9V5.52H1.07A10 10 0 000 10c0 1.61.39 3.13 1.07 4.48l3.33-2.59z" fill="#FBBC05"></path><path d="M10 3.96c1.47 0 2.8.51 3.84 1.5L16.7 2.6A9.97 9.97 0 0010 0 9.99 9.99 0 001.07 5.52L4.4 8.1C5.18 5.72 7.39 3.96 10 3.96z" fill="#EA4335"></path></svg>Sign in with Gmail</button><button style="width: 100%; padding: 9px 0px; background: none; border-width: medium; border-style: none; border-color: currentcolor; border-image: initial; font-size: 13px; color: rgb(136, 136, 136); cursor: pointer;">← Back</button><p style="font-size: 12px; color: rgb(136, 136, 136); line-height: 1.6; margin: 16px 0px 0px;">By signing in, you confirm you are accessing this assignment through an authorized link. Unauthorized access attempts are logged.</p></div></div>
                     <!--------------------------------------------------->
                  </div>
   ...
   <script>
      ...
      // const accessDiv = document.querySelector("#accessDiv");
