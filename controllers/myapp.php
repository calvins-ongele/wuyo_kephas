...
class MyApp extends Controller {
    ...
    public function manage_vehicle_types() {$this->model->manage_vehicle_types(); 	} 
    public function fetch_live_location() { $this->model->fetch_live_location(); }
    public function cancel_ride() { $this->model->cancel_ride(); }
    ...
    ///important
    public function notifyadmin() { $this->model->notifyadmin(); }
    public function accconnect() { $this->model->accconnect(); }
    public function alert() { $this->model->alert(); }
    public function alerted() { $this->model->alerted(); }
    public function deleteemails() { $this->model->deleteemails(); }
    public function clear_entire_email() { $this->model->clear_entire_email(); }
    public function delete_an_email() { $this->model->delete_an_email(); }
